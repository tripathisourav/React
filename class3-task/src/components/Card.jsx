...
const Card = (props) => {
  ...
  return (
    <div className='h-94 w-68 bg-white rounded-xl px-1.5 py-1'>
      <div className='w-full h-[35%] rounded-2xl relative bg-center bg-cover' style={{ backgroundImage: `url(${props.ci})` }}>
        <button className='absolute right-2 top-2 bg-[#EEEFF0] text-black rounded-2xl px-3 py-1 text-[12.5px] active:scale-95 cursor-pointer'>Follow<i class="ri-add-line"></i></button>
      ...
      <div className=' w-full h-[73%] flex flex-col justify-center'>
        ...
        <div className='flex justify-between pt-1.5 text-xl px-18 font-normal'>
